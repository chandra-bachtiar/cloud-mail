<template>
  <div id="login-box" :style=" background ? 'background: var(--el-bg-color)' : ''" v-loading="oauthLoading" :element-loading-text="$t('oauthLoading')">
...
window.onTurnstileError = (e) => {
  ...
  verifyErrorCount++
  console.warn('Turnstile verification failed to load', e)
  setTimeout(() => {
    nextTick(() => {
      if (!turnstileId) {
      ...
      nextTick(() => {
        if (!turnstileId) {
          try {
            ...
            console.log('Turnstile JS failed to load')
          }
        } else {
