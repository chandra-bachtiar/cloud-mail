...
function initEditor() {
  window.tinymce.init({
    ...
    height: "100%",
    auto_focus: true,
    //relative_urls: false,  // Prevent auto-converting links to relative paths when img domain matches site domain
    //remove_script_host: false, // Prevent removing domain from URLs
