...
const dbInit = {
	...
	async v1_6DB(c) {
		...
		const noticeContent = 'This project is for learning and communication only. Do not use for illegal business.\n' +
			'<br>\n' +
			'Please comply with local regulations. The author assumes no legal liability.'
    ...
    `).run();
		...
		try {
			...
			console.warn(`Skip index creation:${e.message}`);
		}
